...
class _InvoiceFilterScreenState extends ConsumerState<_InvoiceFilterScreen> {
  ...
  Future<void> _share(BuildContext context) async {
    ...
    final file  = File('${tmp.path}/invoice_report.pdf');
    await file.writeAsBytes(bytes);
    await Share.shareXFiles([XFile(file.path)], text: 'Customer Invoice Report');
  }
  ...
  Future<void> _download(BuildContext context) async {
    ...
    final file  = File('${tmp.path}/invoice_report.pdf');
    await file.writeAsBytes(bytes);
    if (mounted) showToast(context, '✅ Saved to ${file.path}', success: true);
  }
