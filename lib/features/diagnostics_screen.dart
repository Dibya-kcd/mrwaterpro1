...
class _NodeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (result.running)          cardBorderColor = warnC.withValues(alpha: 0.5);
    else if (result.hasError)    cardBorderColor = errC.withValues(alpha: 0.4);
    else if (result.allOk)       cardBorderColor = okC.withValues(alpha: 0.3);
    else                         cardBorderColor = isDark ? AppColors.separatorDark : AppColors.separator;
